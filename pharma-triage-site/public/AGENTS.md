...
> سياق دائم يتنقّل مع فولدر المشروع على الهارد البورتابل. Codex بيقرا الملف ده تلقائياً كل سيشن من أي جهاز (لأنه في جذر المشروع، أب لمجلد العمل `public`). حدّثه لما يتغيّر حاجة مهمة. **ممنوع كتابة كلمات سر أو أسرار هنا.**
